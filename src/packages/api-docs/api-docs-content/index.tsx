...
import { slugifyApiDocs } from '@/utils/string';
 ...
 */
export const ApiDocsContent = ({ catalog }: ApiDocsContentProps) => {
  return (
...
const styles = {
  ...
  overviewGroup: `scroll-mt-8 border-b border-slate-200 pb-8`,
  overviewTitle: `text-3xl font-semibold text-slate-900`,
  meta: `mt-3 text-sm text-slate-600`,
  envelope: `mt-2 text-sm text-slate-600`,
  overviewDesc: `mt-4 text-sm text-slate-600 leading-relaxed [&+&]:mt-3`,
  code: `rounded bg-slate-100 px-1.5 py-0.5 font-mono text-xs`,
  group: `scroll-mt-8`,
  groupTitle: `text-2xl font-semibold text-slate-900`,
  groupDesc: `mt-2 text-sm text-slate-600 leading-relaxed [&+&]:mt-2`,
  endpoints: `mt-6 space-y-6`,
};
